            ...
            <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
                <div className="lg:max-w-lg lg:self-end">
                    ...
                    <section aria-labelledby="information-heading" className="mt-4">
                        ...
                        <div className="mt-4 space-y-6">
                            <p className="text-base text-gray-500">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                        </div>
                        ...
                        <div classNameName='flex items-center'>
                            <button className="mt-10 w-1/2 bg-indigo-600 hover:bg-indigo-400 hover:text-indigo-900 text-white py-2 px-4 transition duration-300 ease-in-out">
                                Add To Cart
                            </button>
                            <button className="w-1/2 bg-orange-600 hover:bg-orange-400 hover:text-orange-900 text-white py-2 px-4 transition duration-300 ease-in-out">
                                Order now
                            </button>
                ...
                <div className="mt-10 lg:mt-0 lg:col-start-2 lg:row-span-2 lg:self-center">
                    <div className="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden">
                        <Image height={150} width={300} src={product.img} alt={product.name} className="w-full h-full object-center object-cover" />
                    </div>
                </div>
            </div>
        </div>
